          ...
          <BreakdownRow tableMaxW={tableMaxW}>
            <BreakdownCell flex={1} narrow={narrow}>
              <Text style={{ ...T.caption, fontWeight: '600', color: C.muted }} numberOfLines={1}>
                {t('dashboard.expensesScreen.table.expense')}
              </Text>
            </BreakdownCell>
            ...
            <BreakdownCell width={shareColW} align="center" narrow={narrow}>
              <Text style={{ ...T.caption, fontWeight: '600', color: C.muted, textAlign: 'center' }} numberOfLines={1}>
                {t('dashboard.expensesScreen.table.share')}
              </Text>
            </BreakdownCell>
          </BreakdownRow>
        </View>
            ...
            {sections.map((section, sectionIdx) => {
              ...
              const headerRow = (
                <BreakdownRow tableMaxW={tableMaxW}>
                  ...
                  <BreakdownCell width={shareColW} align="center" narrow={narrow}>
                    <Text style={{ fontSize: 14, fontWeight: '600', color: C.muted, textAlign: 'center', ...tabularNums }} numberOfLines={1}>
                      {sectionPct}
                    </Text>
                  </BreakdownCell>
                </BreakdownRow>
                      ...
                      return (
                        ...
                        >
                          <BreakdownRow style={{ paddingLeft: narrow ? 8 : 14 }} tableMaxW={tableMaxW}>
                            ...
                            <BreakdownCell width={shareColW} align="center" narrow={narrow}>
                              <Text style={{ ...T.caption, color: C.muted, fontWeight: '500', textAlign: 'center', ...tabularNums }} numberOfLines={1}>
                                {itemPct}
                              </Text>
                            </BreakdownCell>
                          </BreakdownRow>
