...
export function buildWasteTaxMemberSummary(household, t) {
  ...
  if (adultCount === 1) {
    parts.push(t('onboarding.housing.q6g.wasteTaxSummaryOneAdult'));
  } else {
    parts.push(t('onboarding.housing.q6g.wasteTaxSummaryAdults', { count: adultCount }));
  }
  ...
  if (fullChildren === 1) {
    parts.push(t('onboarding.housing.q6g.wasteTaxSummaryChildFull'));
  } else if (fullChildren > 1) {
    parts.push(t('onboarding.housing.q6g.wasteTaxSummaryChildrenFull', { count: fullChildren }));
  }
  if (reducedChildren === 1) {
    parts.push(t('onboarding.housing.q6g.wasteTaxSummaryChildReduced'));
  } else if (reducedChildren > 1) {
    parts.push(t('onboarding.housing.q6g.wasteTaxSummaryChildrenReduced', { count: reducedChildren }));
  }
  if (exemptChildren === 1) {
    parts.push(t('onboarding.housing.q6g.wasteTaxSummaryChildExempt'));
  } else if (exemptChildren > 1) {
    parts.push(t('onboarding.housing.q6g.wasteTaxSummaryChildrenExempt', { count: exemptChildren }));
  }
